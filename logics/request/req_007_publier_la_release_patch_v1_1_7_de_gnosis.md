## req_007_publier_la_release_patch_v1_1_7_de_gnosis - Publier la release patch v1.1.7 de Gnosis
> From version: 1.1.7
> Schema version: 1.0
> Status: Done
> Understanding: 90%
...
# Needs
Publier une release patch `v1.1.7` de Gnosis afin de déployer effectivement la documentation des assets Icones V3 publiés ; aucun changement runtime.

# Context
- La version précédente livrée était `1.1.6`.
...
# AI Context
- Summary: Draft a bounded request for publier la release patch v1.1.7 de gnosis.
